/*====================================================================
project:       Prueba1 - Armonizacion actualización plataforma CIMA
Author:        Angela Lopez 
Dependencies:  SCL/EDU - IDB 
----------------------------------------------------------------------
Creation Date:    13 Jul 2018 - 11:47:53
Modification Date:   
Do-file version:    01
References:          
...
tempfile tablas
tempname ptablas
postfile `ptablas' str30(Ano Indicador Pais Nivel Clase Valor Fuente_Especifica Circa) using `tablas', replace
...
local indicadores tasa_bruta_asis tasa_neta_asis tasa_asis_edad Años_Escolaridad_25_mas tasa_no_asis_edad  Ninis_2 leavers tasa_terminacion_c tasa_bruta_asis_c tasa_neta_asis_c tasa_sobre_edad
...
* Tasa bruta de asistencia customizada							
							
						if "`indicador'" == "tasa_bruta_asis_c" {
				...
				* Primaria   
								capture sum age_prim_c [w=factor_ci]	 if `clase'==1 & asiste_ci!=.
								if _rc == 0 {
								local pop_prim = `r(sum)'
								
								sum asis_prim_c [w=factor_ci]	 if `clase'==1 & edad_ci>=6 & asiste_ci!=.
								local numerador = `r(sum)'
								local valor = (`numerador' / `pop_prim') * 100 
								post `ptablas' ("`ano'") ("`indicador'") ("`pais'") ("Primaria")  ("`clase'") ("`valor'") ("`encuesta'") ("`year'") 
								}
				...
				* Secundaria 
								capture sum age_seco_c [w=factor_ci]	if `clase'==1 & asiste_ci!=.
								if _rc == 0 {
								local pop_seco = `r(sum)'	
				
								sum asis_seco_c [w=factor_ci]	 if `clase'==1 & edad_ci>=6 & asiste_ci!=.
								local numerador = `r(sum)'
								local valor = (`numerador'/ `pop_seco') * 100 
								post `ptablas' ("`ano'") ("`indicador'") ("`pais'") ("Secundaria")  ("`clase'") ("`valor'") ("`encuesta'") ("`year'") 
								}
				...
				*Terciaria
								capture sum age_tert_c [w=factor_ci]	if `clase'==1 & asiste_ci!=.
								if _rc == 0 {
								local pop_tert = `r(sum)'	
								
								sum asis_tert_c [w=factor_ci]	 if `clase'==1 & edad_ci>=6 & asiste_ci!=.
								local numerador = `r(sum)'
								local valor = (`numerador'/ `pop_tert') * 100 
								post `ptablas' ("`ano'") ("`indicador'") ("`pais'") ("Superior")  ("`clase'") ("`valor'") ("`encuesta'") ("`year'") 
								} /*cierro if*/										
...
/*Tasa de Asistencia Neta*/
				...
				*Secundaria Baja 
						/*		capture sum age_seco_b [w=factor_ci]	if `clase'==1 & asiste_ci!=.
								...
								sum asis_seco_b [w=factor_ci]	 if `clase'==1 & age_seco_b == 1 & asiste_ci!=.
								local numerador = `r(sum)'
								local valor = (`numerador' / `pop_seco_b') * 100 
								post `ptablas' ("`ano'") ("`indicador'") ("`pais'") ("Secundaria_Baja") ("`clase'") ("`valor'") ("`encuesta'") 
								}
				...
				*Secundaria Alta
								...
								sum asis_seco_a [w=factor_ci]	 if `clase'==1 & age_seco_a == 1 & asiste_ci!=.
								local numerador = `r(sum)'
								local valor = (`numerador' / `pop_seco_a') * 100 
								post `ptablas' ("`ano'") ("`indicador'") ("`pais'") ("Secundaria_Alta")  ("`clase'") ("`valor'") ("`encuesta'") 
								} cierro if*/
...
/*Tasa de Asistencia Neta Costumizada */
						if "`indicador'" == "tasa_neta_asis_c" {	
				...
				* Primaria   
								...
								sum asis_prim_c [w=factor_ci]	 if `clase'==1 & age_prim_c==1 & asiste_ci!=.
								local numerador = `r(sum)'
								local valor = (`numerador' / `pop_prim') * 100 
								post `ptablas' ("`ano'") ("`indicador'") ("`pais'") ("Primaria") ("`clase'") ("`valor'") ("`encuesta'") ("`year'") 
								}
				...
				* Secundaria 
								...
								sum asis_seco_c [w=factor_ci]	 if `clase'==1 & age_seco_c == 1 & asiste_ci!=.
								local numerador = `r(sum)'
								local valor = (`numerador' / `pop_seco') * 100 
								post `ptablas' ("`ano'") ("`indicador'") ("`pais'") ("Secundaria") ("`clase'") ("`valor'") ("`encuesta'") ("`year'") 
								}
				...
				*Superior
								...
								sum asis_tert_c [w=factor_ci]	 if `clase'==1 & age_tert_c == 1 & asiste_ci!=.
								local numerador = `r(sum)'
								local valor = (`numerador' / `pop_tert') * 100 
								post `ptablas' ("`ano'") ("`indicador'") ("`pais'") ("Superior")  ("`clase'") ("`valor'") ("`encuesta'") ("`year'") 
								} /*cierro if*/
...
*Ninis no ocupados no asisten*/
						if "`indicador'" == "Ninis_1" {									
				* 15-24   
								capture sum age_15_24 [w=factor_ci]	 if `clase'==1 & edad_ci !=.
								if _rc == 0 {
								local pop_15_24 = `r(sum)'

								sum age_15_24 [w=factor_ci]	 if `clase'==1 & asiste_ci==0 & condocup_ci != 1 & edad_ci !=.
								local numerador = `r(sum)'
				...
				* 15-29   
								...
								*if _rc == 0 {
								...
								sum age_15_29 [w=factor_ci]	 if `clase'==1 & asiste_ci==0 & condocup_ci != 1 & edad_ci !=.
								local numerador = `numerador'
								local valor = (`r(sum)' / `pop_15_29') * 100 
...
* Tasa de terminación*/
						if "`indicador'" == "tasa_terminacion" {	
							
				*Primaria

								capture sum age_seco_b [w=factor_ci]	 if `clase'==1 & tprimaria !=.
								if _rc == 0 {
								local pop_12_14 = `r(sum)'
															
								sum tprimaria [w=factor_ci]	 if `clase'==1 & edad_ci>=12 & edad_ci<=14 & tsecundaria  !=.
								local numerador = `r(sum)'
								local valor = (`numerador' / `pop_12_14') * 100 
								post `ptablas' ("`ano'") ("`indicador'") ("`pais'") ("Primaria") ("`clase'") ("`valor'") ("`encuesta'") ("`year'") 
								}
				...
				*Secundaria		
								...
								capture sum age_terms [w=factor_ci]	 if `clase'==1 
								if _rc == 0 {
								local pop_18_20 = `r(sum)'
								
								sum tsecundaria [w=factor_ci]	 if `clase'==1 & edad_ci>=18 & edad_ci<=20
								local numerador = `r(sum)'
